...
<!-- bloc-2 -->
<div class="bloc tc-napier-green bgc-mint-cream" id="bloc-2">
					...
					<div class="panel-body">
						<form id="ingreso" >
							...
							<div class="text-center">
								<button class="bloc-button btn btn-napier-green" id="ingresar" type="button">
									INGRESAR
								</button>
							</div>
						</form>
					</div>
				</div><a href="registro.php" class="a-btn a-block ltc-napier-green">¿No estas registrado? JUST DO IT!</a><a href="recuperar-contra.php" class="a-btn a-block ltc-napier-green">Recuperar CONTRASEÑA</a>
			</div>
		</div>
	</div>
</div>
...
<!-- Main container END -->
	...
	<div class="ventana5" name="error">
	    <div class="panel panel-fondo mensaje" >
	        <div class="panel-body">
	        	Error al ingresar al sistema, intentelo más tarde
	        </div>
	        <div class="form-group">
                <br><br>
